...
import { Cog, Gift, Headphones, HelpCircle, Inbox, Menu, Mic, Phone, Pin, PlusCircle, PlusCircleIcon, Search, Smile, Sticker, UserCircle, Video } from "lucide-react";
    ...
    return <div className="flex min-h-[800px] w-full max-w-[1200px] bg-[#202225] text-white rounded-lg overflow-hidden shadow-lg">
        ...
        <div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
            ...
            <div className="flex-1 overflow-y-auto pt-4">
                ...
                <div className="px-2 mb-4 ">
                    <h3 className="text-sm font-semibold text-[#8e9297] px-2 mb-2 uppercase">Direct Messages</h3>
                    <div className="flex items-center px-2 py-15 rounded bg-[#393c43] text-white cursor-pointer">
                        <Image src="/brand-asset-profile-picture.png" alt="PingPanda Avater" width={32} height={32} className="object-cover mr-2 rounded-full"/>
        ...
        <div className="flex-1 flex flex-col">
            <div className="h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#202225]">
                <div className="md:hidden mr4">
                    <Menu className="size-6 text-[#b9bbbe] hover:text-white cursor-pointer"/>
                </div>
                <div className="flex items-center">
                    <div className="relative">
                        <Image src="/brand-asset-profile-picture.png" alt="PingPand discord" width={40} height={40} className="object-cover rounded-full mr-3"/>
            ...
            <div className="p-4">
                <div className="flex items-center bg-[#40444b] rounded-lg p-1">
                    ...
                    <input readOnly type="text" placeholder="Message @PingPanda" className="flex-1 bg-transparent text-white py-2.5 px-1 placeholder-[#72767b] focus:outline-none cursor-not-allowed"/>
